<x-app-layout>
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{route('brands.create')}}"> <button type="button" class="btn btn-primary float-right" >
        Create Brand
      </button></a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td><img src="{{ asset('storage/brands/'.$item->image) }}" height="50px" width="50px" alt="" title=""></td>
          <td>  
            <div class="row"> 
              <a href="{{ URL::to('brands/' . $item->id . '/edit')}}" class="">
