        ...
        <div class="container-fluid">
          ...
          <div class="card card-default">
                        ...
                        <!-- /.col -->
                          <div class="col-12 col-sm-6">
                            <div class="form-group">
                              ...
                              <select class="form-control select2" required name="cat_id" style="width: 100%;">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea id="editor1" placeholder="Enter Detail" name="description" placeholder="Enter  Description"> </textarea>
                                  </div>
                                </div>
            ...
            <div class="col-12 col-sm-6">
                                          ...
                                          <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                 <label for="">Add Video Url</label>
                                            <input type="text"  class="form-control" id="" name="video">
                                            @error('video')<span class="text-red-700" style="color:red;">{{$message}}  </span>@enderror  
                                          </div>
                                          </div>
                                <hr>
                                        ...
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <div class="col-sm-6">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="" name="meta_keywords" placeholder="Focus Key Phrases">
                                            </div>
                                            </div>
                                            <div class="col-sm-6">
                                              <div class="form-group">
                                                <label for="exampleInputEmail1">Slug</label>
                                                <input type="text" class="form-control" id="blog_slug" name="blog_slug" placeholder="Enter  Slug" >
                                                </div>
                                              </div>
