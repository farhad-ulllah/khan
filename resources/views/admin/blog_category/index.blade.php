<x-app-layout>
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{route('blogCat.create')}}"> <button type="button" class="btn btn-primary float-right" >
        Create Category
      </button></a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>  
            <div class="row"> 
             <a href="{{ URL::to('blogCat/' . $item->id . '/edit')}}" class="">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <form action="{{ route('blogCat.destroy', $item->id)}}" method="post">
          @csrf
          @method('DELETE')
