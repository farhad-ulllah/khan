                                       ...
                                       <div class="col-12 col-sm-6">
                                        ...
                                        <div class="col-12 col-sm-6">
                                          <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" name="meta_description" id=""  value="{{$category->meta_description}}" placeholder="meta Description">{{$category->meta_description}}</textarea>
                                          </div>
                                          </div>
